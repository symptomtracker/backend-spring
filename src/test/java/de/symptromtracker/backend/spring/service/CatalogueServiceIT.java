...
@Transactional
public class CatalogueServiceIT {
    ...
    public void checkMapping() {
        List<SymptomCatalogueItem> symptomCatalogueItemList = catalogueService.getAllCatalogueItems();
        assertThat(symptomCatalogueItemList.size()).isEqualTo(2);
    }
}
